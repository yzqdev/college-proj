...
function showdetails(courseGroup_id) {
  ...
  function succeedFunction(data) {
    ...
    var coursesT =
      '{"success": true, "message": "请求成功", "data": [ ' + t1[1] + "]}";
    ...
    var teacherT =
      '{"success": true, "message": "请求成功", "data": [ ' + t2[1] + "]}";
    ...
    var courseGroupT =
      '{"success": true, "message": "请求成功", "data":' + t32[1] + "}}";
...
function getCourseById(course_id) {
  ...
  function succeedFunction(data) {
    ...
    for (var i = data.data.teachers.length - 1; i >= 0; i--) {
      $("#cteacher").append(
        "<option value='" +
          data.data.teachers[i].id +
          "'>" +
          data.data.teachers[i].name +
          "</option>"
      );

          ...
          $(".learning").append(`<div class="course">
                        ...
                        <div class="course-bottom">
                          ...
                          <div class="title">
                            ...
                            <a href="/course.html?${
                              data.data.list[i].id
                            }" title="" class="btn btn-info">进入学习</a>
                          </div>
                        </div>
                    </div>`);
      ...
      if (data.success) {
        ...
        $.each(_data, function (index, items) {
          oThis
            ...
            .find(".hf-list-con")
            .append(
              '<div class="all-pl-con"><div class="pl-text hfpl-text clearfix"><a href="#" class="comment-size-name">' +
                _data[index].from +
                ': </a><span class="my-pl-con"><a href="#" class="atName">@' +
                _data[index].to +
                "</a> : " +
                _data[index].content +

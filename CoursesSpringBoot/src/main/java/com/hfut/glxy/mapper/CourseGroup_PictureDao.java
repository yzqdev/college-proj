...
public interface CourseGroup_PictureDao {
    ...
    */
    @Update("update coursegroup_picture set isDelete=1 where coursegroup_id=#{courseGroup_id} and picture_id=#{picture_id} and isDelete=0")
    ...
    /**
         ...
         * @condition   将与课程组相关的图片放入回收站（一般来说一个课程组对应一张图片，即只有一个关系发生改变）
    */
    @Update("update coursegroup_picture set isDelete=1 where coursegroup_id=#{courseGroup_id} and isDelete=0")
    ...
    */
    ...
    Integer addCourseGroup_picture(@Param("courseGroup_id") String courseGroup_id, @Param("picture_id") String picture_id);

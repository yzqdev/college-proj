...
public interface Unit_KnowledgePointDao {
    ...
    */
    ...
    /**
         ...
         * @condition  删除教学单元知识点
    */
    @Update("update unit_knowledgepoint set isDelete=1 where unit_id=#{unit_id} and isDelete=0")
    Integer deleteByUnit(@Param("unit_id") String unit_id);
}

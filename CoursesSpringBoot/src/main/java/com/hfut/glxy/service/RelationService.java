...
public interface RelationService {
    ...
    */
    ...
    /**
         ...
         * @condition
    */
    Video bindUnit_video(String unit_id, String video_id) throws Exception;
    ...
    Office bindCourse_office(String course_id,String office_id) throws Exception;

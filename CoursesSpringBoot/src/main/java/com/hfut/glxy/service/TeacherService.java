...
import com.hfut.glxy.filter.AdminFilter;
...
public interface TeacherService {
    ...
    */
    ...
    /**
         ...
         * @condition  获取课程的负责教师
    */
    List<Teacher> getTeachersByCourse(Course course) throws Exception;
    ...
    /**   
         ...
         * @condition  上传教师图片
    */
    int uploadTeacherPicture(String teacher_id,String picture_id) throws Exception;

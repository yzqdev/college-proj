...
public class CourseServiceImpl implements CourseService {
    ...
    */
    ...
    public int putToDustbin(String course_id) throws Exception {
        ...
        String[] chapter_ids=course_chapterDao.getChaptersByCourse(course_id);
        for (String chapter_id:chapter_ids){
            ...
            try{
                ...
                throw new RuntimeException("删除章节出现错误");
            }
        }
                ...
                for (String teacher_id : teacher_ids) {
                    ...
                    if (course_ids==null){
                        ...
                        for (String courseId : course_ids) {
                            ...
                            }else if (courseGroupId.equals(courseGroup_id)) {
                                count++;
                            }
                        }
                    }
    ...
    */
    @Override
    public int uploadCoursePicture(String course_id,String picture_id) throws Exception{

        String currentPicture_id=course_pictureDao.getCurrentPictureIdByCourse(course_id);
        //当前没有课程图片
        if (currentPicture_id==null){

            int addCoursePictureSuccess;
            addCoursePictureSuccess=course_pictureDao.addCourse_picture(course_id,picture_id);
            if (addCoursePictureSuccess!=1){
        ...
        //先前存在课程的图片，现在进行修改，即上传了一张新的图片
            ...
            deleteRelationSuccess=course_pictureDao.deleteCourse_picture(course_id);
            if (deleteRelationSuccess!=1){
                throw new RuntimeException("删除课程图片关系失败");
            }

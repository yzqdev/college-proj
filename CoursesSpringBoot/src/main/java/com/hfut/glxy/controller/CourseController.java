...
public class CourseController {
    ...
    */
    @ResponseBody
    @RequestMapping(value = "/uploadCoursePicture",method = RequestMethod.POST)
    public Result<String> uploadCoursePicture(@RequestBody Map map){
        ...
        if (course_id==null||picture_id==null){
            return new Result<>(false,"未选择课程或未上传图片",null);
        }
        ...
        try{
            ...
            success=courseService.uploadCoursePicture(course_id,picture_id);
            if (success==0){

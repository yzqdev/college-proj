...
public class PageController {
    ...
    @RequestMapping(value = "/chapterManager", method = RequestMethod.GET)
    public String addChapter() {
        return "admin/chapterManager";
    }
    ...
    @RequestMapping(value = "/morelessons", method = RequestMethod.GET)
    public String morelessons() {
        return "student/morelessons";
    }
    ...
    //测试专区
    @RequestMapping(value = "/testUploadingCoursePicture",method = RequestMethod.GET)
    public String testUploadingCoursePicture(){ return "test/upload"; }

    @RequestMapping(value = "/testUploadingTeacherPicture",method = RequestMethod.GET)
    public String testUploadingTeacherPicture(){ return "test/uploadTeacherPicture"; }

    @RequestMapping(value = "/testUploadingCourseGroupPicture",method = RequestMethod.GET)
    public String testUploadingCourseGroupPicture(){ return "test/uploadCourseGroupPicture"; }
}
